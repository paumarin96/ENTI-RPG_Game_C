...
Item items[20] = {RichardsHatred, SwiftBoots, WhitePowder, RadevMug, RavenFeather, RedMushroom, UglyFacemask, BrokenShield, GreenMushroom, NaughtyBook, IceCube, Candy, EnergyDrink, Horchata, CupCake, Yogurt, Banana, Ensaimada, HappySeal, MoonStone };
